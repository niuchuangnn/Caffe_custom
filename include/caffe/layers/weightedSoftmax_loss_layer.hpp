...
#ifndef CAFFE_WEIGHTEDSOFTMAX_LOSS_LAYER_HPP
#define CAFFE_WEIGHTEDSOFTMAX_LOSS_LAYER_HPP
...
//                                  const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom);
        ...
        bool has_label_scales_;
        vector<int> label_ids_;
        vector<Dtype> label_scales_;
    };

}  // namespace caffe

#endif //CAFFE_WEIGHTEDSOFTMAX_LOSS_LAYER_HPP
